...
<!-- sql query for making foreign key
 ALTER TABLE news (table name)
ADD FOREIGN KEY (category_id)(tyo table ko id)
REFERENCES categories(id)  arko able ko ref id jaslai chiyako xa teslai ho-->